...
drone_lon = -1 * df['longitude'].iloc[0]
...
# grey_lower = (0, 10, 10)
# grey_upper = (255, 255, 255)
grey_lower = (10, 10, 100)
grey_upper = (100, 60, 200)
...
mod_rec = drawRectangles(final_contoured, 2, vid_rect_spacing, 150, final_contoured)
...
while cap.isOpened():
    ...
    if (ct >= 5):
        ...
        drone_lon = -1 * df['longitude'].iloc[i]
